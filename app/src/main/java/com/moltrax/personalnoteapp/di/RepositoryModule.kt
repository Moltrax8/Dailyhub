...
import com.moltrax.personalnoteapp.data.repository.VaultRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds @Singleton abstract fun bindVaultRepo(impl: VaultRepositoryImpl): VaultRepository
}
